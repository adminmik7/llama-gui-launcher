...
| Файл chat template | Jinja-шаблон для чата (опционально) | `C:\models\template.jinja` |
...
- Load Mode (--load-mode none): включена (Windows)
- Batch size: `512`–`1024`
...
- Выберите файл `.jinja` или `.json` в поле «Файл chat template»
